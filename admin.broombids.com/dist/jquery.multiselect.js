...
{
    return '<div class="form-group col-md-6"><label for="fname">Enter '+textboxname+' Location Address</label><input type="text" class="form-control" id="'+textboxname+'" name="'+textboxname+'" placeholder="Address of '+textboxname+'"></div>';
}