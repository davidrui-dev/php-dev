                ...
                <div class="header-inner">
                    ...
                    <nav class="site-nav nav-two">
                        ...
                        <div class="menu-wrapper" data-top="992">
                            ...
                            <ul class="site-main-menu">
                                ...
                                <li class="menu-item-has-children">
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li><a href="<?=PROOT?>HowItWorks">Customer</a></li>

                                            <li><a href="<?=PROOT?>HowItWorks/vendor">Vendor</a></li>
                                ...
                                <li>
                                    <a href="<?=PROOT?>faq">FAQ</a>
                                    <ul class="sub-menu">
                                        <li><a href="<?=PROOT?>faq/customer">Customer</a></li>
                                        <li><a href="<?=PROOT?>faq/vendor">Vendor</a></li>
                                    </ul>
                                </li>                                
                                ...
                                <?php if(isset($_SESSION['master_id'])) { ?>
                                    ...
                                    <li id="myaccountmenu"><a href="<?=PROOT?>dashboard">My Account</a></li>                                

                                <?php } else { ?>

                                    <li id="myaccountmenu"><a href="<?=PROOT?>login">Login / Sign Up</a></li>                                
                            ...
                            <div class="nav-right"><a href="<?=PROOT?>dashboard" class="nav-btn">My Account</a></div>

                            <?php } else { ?>

                            <div class="nav-right"><a href="<?=PROOT?>login" class="nav-btn">Login / Sign Up</a></div>
