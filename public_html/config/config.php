...
//		define('PROOT','/broombids_new/'); // set this to '/' for a live server
    ...
    define('REDIRECT_URI','http://localhost:8000/public_html/Login/google_callback');//example:http://localhost/social/login.php?google,http://example/login.php?google
